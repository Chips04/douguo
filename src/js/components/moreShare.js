  ...
  render(){
    return(
      <div className="moreShare">
        ...
        <ul>
          <li>
            <i><img src="src/images/weibo.png"/></i><span>新浪微博</span><b><img onClick={this.weiboBtn.bind(this)} src={"src/images/"+ (this.props.weibovalue?'btn_on':'btn_off') +".png"} /></b>
          </li>
          <li>
            <i><img src="src/images/qblog.png"/></i><span>腾讯微博</span><b><img onClick={this.qblogBtn.bind(this)} src={"src/images/"+ (this.props.qblogvalue?'btn_on':'btn_off') +".png"}/></b>
          </li>
          <li>
            <i><img src="src/images/elephant.png"/></i><span>印象笔记</span><b><img onClick={this.elephantBtn.bind(this)} src={"src/images/"+ (this.props.elephantvalue?'btn_on':'btn_off') +".png"}/></b>
          </li>
          <li>
            <i><img src="src/images/qzone.png"/></i><span>QQ空间</span><b><img onClick={this.qzoneBtn.bind(this)} src={"src/images/"+ (this.props.qzonevalue?'btn_on':'btn_off') +".png"}/></b>
          </li>
        </ul>
